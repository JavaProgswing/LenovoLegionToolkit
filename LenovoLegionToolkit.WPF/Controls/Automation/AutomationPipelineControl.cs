...
public class AutomationPipelineControl : UserControl
{
    ...
    private async Task<AbstractAutomationStepControl> GenerateStepControlAsync(IAutomationStep automationStep)
    {
        AbstractAutomationStepControl control = automationStep switch
        {
            ...
            DisableDoNotDisturbAutomationStep s => new DisableDoNotDisturbAutomationStepControl(s),
            MuteSystemVolumeAutomationStep s => new MuteSystemVolumeAutomationStepControl(s),
            UnmuteSystemVolumeAutomationStep s => new UnmuteSystemVolumeAutomationStepControl(s),
            TurnOnNightLightAutomationStep s => new TurnOnNightLightAutomationStepControl(s),
            TurnOffNightLightAutomationStep s => new TurnOffNightLightAutomationStepControl(s),
